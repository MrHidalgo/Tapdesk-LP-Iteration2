...
/*! Adapted from jQuery UI version 1.4 */
...
$.extend( Datepicker.prototype, {
	...
	_generateHTML: function( inst ) {
		...
		prev = ( this._canAdjustMonth( inst, -1, drawYear, drawMonth ) ?
			...
			" title='" + prevText + "'><span>" + "&xlarr;" + "</span></a>" :
			( hideIfNoPrevNext ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + "&xlarr;" + "'><span>" + "&xlarr;" + "</span></a>" ) );
		...
		next = ( this._canAdjustMonth( inst, +1, drawYear, drawMonth ) ?
			...
			" title='" + nextText + "'><span>" + "&xrarr;" + "</span></a>" :
